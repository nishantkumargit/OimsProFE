...
export class AnalyticsService {
  ...
  public getProductionData(): Array<Object> {
    return [
        {
            id: '1000',
            code: 'f230fh0g3',
...
getProductsMini() {
  return Promise.resolve(this.getProductionData().slice(0, 5));
}

getProductsSmall() {
  return Promise.resolve(this.getProductionData().slice(0, 10));
}

getProducts() {
  return Promise.resolve(this.getProductionData());
}
